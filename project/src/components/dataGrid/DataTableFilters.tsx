          ...
          >
            ...
            {!exportDisabled && (
              <ToggleButton value="export" aria-label="export">
                <Tooltip title="Open export panel">
        ...
        >
          ...
          <DialogContent>
            <FormControl style={{ width: '100%' }}>
              <InputLabel id="redirectionMode">Redirection mode</InputLabel>
              <Select
                value={redirectionMode}
                onChange={(event) => helpers.handleAddProperty('redirectionMode', event.target.value)}
                fullWidth
              >
                <MenuItem value="overview">Redirecting to the Overview section</MenuItem>
                <MenuItem value="knowledge">Redirecting to the Knowledge section</MenuItem>
                <MenuItem value="content">Redirecting to the Content section</MenuItem>
              </Select>
            </FormControl>
          </DialogContent>
          <DialogActions>
