...
const DataTable = (props: OCTIDataTableProps) => {
  ...
  if (availableFilterKeys.length === 0 && isNotEmptyField(computedEntityTypes)) {
    // Simplified filter keys logic without authentication schema
    availableFilterKeys = R.uniq([
      ...computedEntityTypes.flatMap((entityType: string) => [
        'id',
        'name',
        'created_at',
        'updated_at',
