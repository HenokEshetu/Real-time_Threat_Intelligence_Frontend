...
describe('middlewares/auth', function () {
  ...
  it('`token` option as string (with default `prefix` and `header`)', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  it('`token` option as thunk (with custom `prefix` and `header`)', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var rnl, req, res, reqs;
  ...
  it('`tokenRefreshPromise` should be called on 401 response', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var rnl, req, reqs;
  ...
  it('`tokenRefreshPromise` reset refresh token state', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
