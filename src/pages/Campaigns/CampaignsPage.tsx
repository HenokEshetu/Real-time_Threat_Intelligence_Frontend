...
export const CampaignsPage: React.FC = () => {
  ...
  const glowEffects = [
    ...
    { shadow: 'shadow-orange-300', border: 'border-orange-500', text: 'text-orange-600' },
    ...
    { shadow: 'shadow-teal-300', border: 'border-teal-500', text: 'text-teal-600' },
    { shadow: 'shadow-blue-300', border: 'border-blue-500', text: 'text-blue-600' },
    { shadow: 'shadow-indigo-300', border: 'border-indigo-500', text: 'text-indigo-600' },
    ...
    { shadow: 'shadow-rose-300', border: 'border-rose-500', text: 'text-rose-600' },
    { shadow: 'shadow-amber-300', border: 'border-amber-500', text: 'text-amber-600' },
    { shadow: 'shadow-lime-300', border: 'border-lime-500', text: 'text-lime-600' },
    {
    ...
    { shadow: 'shadow-violet-300', border: 'border-violet-500', text: 'text-violet-600' },
    {
    ...
    { shadow: 'shadow-slate-400', border: 'border-slate-500', text: 'text-slate-600' },
            ...
            <CardContent className="p-5 flex flex-col h-full relative z-10">
              ...
              <div className="flex flex-col gap-1 mb-2">
                <div className="text-xs text-muted-foreground">
                  <span className="font-medium">first_seen:</span> {formatDate(campaign.first_seen)}
                </div>
                <div className="text-xs text-muted-foreground">
                  <span className="font-medium">last_seen:</span> {formatDate(campaign.last_seen)}
                </div>
              </div>
            </CardContent>
          </Card>
