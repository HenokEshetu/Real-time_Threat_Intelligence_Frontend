...
//   ChevronLeft,
// } from 'lucide-react';
// import { ThreatActorType } from '../../types/threat-actor';
...
//   },
//   {
//     value: 'INSIDER_ACCIDENTAL',
//     label: 'Insider (Accidental)',
//     icon: <Info className="w-4 h-4" />,
//     color: 'from-gray-400 to-gray-200',
//   },
//   {
//     value: 'INSIDER_DISGRUNTLED',
...
//     label: 'Terrorist',
//     icon: <AlertTriangle className="w-4 h-4" />,
//     color: 'from-red-800 to-yellow-400',
//   },
//   {
//     value: 'UNKNOWN',
//     label: 'Unknown',
...
export default function CreateOrEditThreatActor() {
  ...
  //         setSuccess(true);
  //         setTimeout(
  //           () => navigate(`/threat-actors/${res.data.updateThreatActor.id}`),
  //           1200,
  //         );
  //       } else {
  ...
  //         setSuccess(true);
  //         setTimeout(
  //           () => navigate(`/threat-actors/${res.data.createThreatActor.id}`),
  //           1200,
  //         );
  //       }
  //     } catch (err: any) {
  ...
  //         <div className="text-blue-700 dark:text-cyan-300 font-semibold text-lg mt-4">
  //           Loading Threat Actor...
  //         </div>
  //       </div>
  //     );
  //   }
  ...
  //     <div
  //       className={`transition-all duration-300 rounded-full w-12 h-12 flex items-center justify-center shadow-lg
  //       ${
  //         active
  //           ? 'bg-gradient-to-br from-blue-600 to-cyan-400 scale-110 ring-4 ring-blue-200'
  //           : done
  //           ? 'bg-gradient-to-br from-green-400 to-cyan-300'
  //           : 'bg-gradient-to-br from-zinc-400 to-zinc-200 opacity-60'
  //       }
  //       `}
  //     >
  //       {icon}
  ...
  return (
    ...
    //                 </div>
    //                 {i < steps.length - 1 && (
    //                   <div className="w-1 h-8 bg-gradient-to-b from-blue-200 to-blue-50 dark:from-zinc-700 dark:to-zinc-900 mx-auto" />
    //                 )}
    //               </div>
    //             ))}
    //           </div>
    ...
    //           className="flex-1 space-y-8 py-8 px-4 md:px-0 relative"
    //         >
    ...
    //                 <span role="img" aria-label="paperclip" className="text-3xl">
    //                   📎
    //                 </span>
    //               </div>
    //             </div>
    ...
    //                 {isEdit ? 'Edit Threat Actor' : 'Create Threat Actor'}
    //               </h2>
    //               <div>
    //                 <label className="block font-semibold text-zinc-700 dark:text-zinc-200 mb-2">
    //                   Type
    //                 </label>
    ...
    //                         ${
    //                           form.type === opt.value
    //                             ? 'border-blue-700 scale-105 ring-2 ring-blue-400'
    ...
    //                   Choose the main type of this threat actor.
    //                 </div>
    //               </div>
    //               <FloatingLabelInput
    //                 label="Name"
    ...
    //                   handleArrayChange('roles', e.target.value)
    //                 }
    ...
    //                 onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
    //                   handleArrayChange('aliases', e.target.value)
    //                 }
    //               />
    //               <FloatingLabelInput
    ...
    //                 onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
    //                   handleArrayChange('labels', e.target.value)
    //                 }
    //               />
    ...
    //                     <span className="px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-600 to-cyan-400 text-white shadow">
    //                       {form.type}
    //                     </span>
    //                   </div>
    ...
    //                       <span
    //                         key={l}
    //                         className="px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-300 to-cyan-200 text-blue-900"
    //                       >
    //                         {l}
    //                       </span>
    //                     ))}
    ...
    //                       <span
    //                         key={r}
    //                         className="px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-200 to-blue-400 text-blue-900"
    //                       >
    //                         {r}
    //                       </span>
    //                     ))}
    ...
    //                       <b>Sophistication:</b>&nbsp;{form.sophistication}
    //                     </div>
    //                     <div className="flex items-center">
    //                       <span className="mr-1">💰</span>
    //                       <b>Resource Level:</b>&nbsp;{form.resource_level}
    //                     </div>
    //                     <div className="flex items-center">
    //                       <span className="mr-1">🎯</span>
    //                       <b>Primary Motivation:</b>&nbsp;{form.primary_motivation}
    //                     </div>
    //                     <div className="flex items-center">
    //                       <span className="mr-1">🕵️</span>
    //                       <b>Aliases:</b>&nbsp;{form.aliases.join(', ')}
    //                     </div>
    //                     <div className="flex items-center">
    //                       <span className="mr-1">📅</span>
    //                       <b>First Seen:</b>&nbsp;{form.first_seen}
    //                     </div>
    //                     <div className="flex items-center">
    //                       <span className="mr-1">⏰</span>
    //                       <b>Last Seen:</b>&nbsp;{form.last_seen}
    //                     </div>
    //                   </div>
    //                 </div>
    //               </div>
