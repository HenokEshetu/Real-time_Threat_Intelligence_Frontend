...
// Helper to chunk tools into columns for vertical honeycomb
...
export const ToolsPage: React.FC = () => {
  ...
  // Number of columns for the honeycomb (adjust as needed)
  const COLS = 4;
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-8 bg-gradient-to-br from-blue-50 via-white to-blue-100">
