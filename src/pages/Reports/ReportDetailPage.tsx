        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {report.report_types?.map((type: string) => (
              <span
                key={type}
                className="inline-flex items-center gap-1 bg-blue-800/80 text-blue-100 px-2 py-0.5 rounded text-xs font-medium"
              >
            ...
            {report.labels?.map((label: string) => (
              <span
                key={label}
                className="inline-flex items-center gap-1 bg-white/20 text-white px-2 py-0.5 rounded text-xs"
              >
            ...
            <div className="flex flex-wrap gap-2">
              {report.authors && report.authors.length > 0 ? (
                report.authors.map((author: string, idx: number) => (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full text-xs font-medium shadow"
                  >
