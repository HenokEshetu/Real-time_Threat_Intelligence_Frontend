...
import { useCreateEmailAddress } from '@/hooks/observables/useEmailAddress';
...
export const EmailAddressObservablesCreatePage = () => {
  const navigate = useNavigate();
  const { createEmailAddress, loading, error } = useCreateEmailAddress();
  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      <div className="w-full bg-background border-b px-4 py-3 flex items-center">
        ...
        <h1 className="text-lg font-semibold">Create an email address observable</h1>
      </div>
