...
import { useCreateDomainName } from '@/hooks/observables/useDomains';
...
export const DomainNameObservablesCreatePage = () => {
  ...
  const { createDomainName, loading: creating, error: createError } = useCreateDomainName();
  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      <div className="w-full bg-background border-b px-4 py-3 flex items-center">
        ...
        <h1 className="text-lg font-semibold">Create a domain name observable</h1>
      </div>
