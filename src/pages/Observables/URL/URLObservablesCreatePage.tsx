...
import { useCreateURL } from '@/hooks/observables/useURLs';

const URL_TYPES = [
  'url', // You can add more types if your schema supports
];
...
export const URLObservablesCreatePage = () => {
  const navigate = useNavigate();
  const [createURL, { loading: creating, error: createError }] = useCreateURL();
  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      <div className="w-full bg-background border-b px-4 py-3 flex items-center">
        ...
        <h1 className="text-lg font-semibold">Create a URL observable</h1>
      </div>
