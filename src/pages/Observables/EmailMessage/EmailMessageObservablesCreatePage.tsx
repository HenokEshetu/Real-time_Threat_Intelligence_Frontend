...
import { useCreateEmailMessage } from '@/hooks/observables/useEmailMessage';
...
export const EmailMessageObservablesCreatePage = () => {
  const navigate = useNavigate();
  const [createEmailMessage, { loading: creating, error: createError }] = useCreateEmailMessage();
  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      <div className="w-full bg-background border-b px-4 py-3 flex items-center">
        ...
        <h1 className="text-lg font-semibold">Create an email message observable</h1>
      </div>
