...
import { useCreateMacAddress } from '@/hooks/observables/useMacAddress';

const MAC_TYPES = [
  'mac-addr', // adjust as needed
];
...
export const MACObservablesCreatePage = () => {
  const navigate = useNavigate();
  const [createMac, { loading: creating, error: createError }] = useCreateMacAddress();
  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      <div className="w-full bg-background border-b px-4 py-3 flex items-center">
        ...
        <h1 className="text-lg font-semibold">Create a MAC observable</h1>
      </div>
