...
import { useCreateIPv6Address } from '@/hooks/observables/useIPv6Address';
...
export const IPv6ObservablesCreatePage = () => {
  const navigate = useNavigate();
  const [createIPv6, { loading: creating, error: createError }] = useCreateIPv6Address();
  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      <div className="w-full bg-background border-b px-4 py-3 flex items-center">
        ...
        <h1 className="text-lg font-semibold">Create an IPv6 observable</h1>
      </div>
